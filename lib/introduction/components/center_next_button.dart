...
class CenterNextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding:
          EdgeInsets.only(bottom: 0 + MediaQuery.of(context).padding.bottom),
      child: Column(
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) => Padding(
                padding: EdgeInsets.only(
                    bottom: 48 - (38 * _signUpMoveAnimation.value)),
                child: Container(
                  height: 58,
                  width: 92 + (200 * _signUpMoveAnimation.value),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(
                        8 + 8 * (1 - _signUpMoveAnimation.value)),
