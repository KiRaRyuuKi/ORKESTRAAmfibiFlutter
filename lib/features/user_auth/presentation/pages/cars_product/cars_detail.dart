...
import 'package:Amfibi_App/features/user_auth/presentation/widgets/product_widgets/add_to_cart.dart';
import 'package:Amfibi_App/features/user_auth/presentation/widgets/product_widgets/appbar.dart';
import 'package:Amfibi_App/features/user_auth/presentation/widgets/product_widgets/image_slider.dart';
...
import 'package:Amfibi_App/features/user_auth/presentation/pages/Message/inquiry_page.dart'; // Import the correct file

class CarsDetail extends StatefulWidget {
  final Cars product;

  const CarsDetail({Key? key, required this.product}) : super(key: key);
              ...
              Container(
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Image.network(widget.product.image[index]);
                  },
                ),
              ),
